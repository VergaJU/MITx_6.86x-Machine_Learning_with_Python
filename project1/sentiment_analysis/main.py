...
#        if round(float(thetas_old[0][0]),decimal) == round(float(thetas[0][0]),decimal) and round(float(thetas_old[0][1]),decimal) == round(float(thetas[0][1]),decimal):
#            patience -= 1
#            if patience == 0:
#                print(f"Algorithm {algorithm} converged after {T} iterations")
 #               break
 #       else:
#            thetas_old = thetas
#            T += 2
#            patience = 5
#    if T == 500:
#        print(f"Algorithm {algorithm} not converged")
...
train_acc, test_acc = p1.classifier_accuracy(p1.pegasos,train_bow_features,
        test_bow_features,
        train_labels,
        test_labels,
        T=25, L=0.01)
